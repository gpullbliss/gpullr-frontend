...
angular.module('headerModule')
    ...
    ['$filter', '$cookieStore', '$rootScope', 'notificationService',
        function ($filter, $cookieStore, $rootScope, notificationService) {
            ...
            function sendNotification(notification) {
                ...
                var options = {
                    body: notificationService.getNotificationMessage(notification),
