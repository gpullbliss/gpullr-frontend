...
describe('desktopNotificationService', function () {
    ...
    beforeEach(function () {
        ...
        inject(function (desktopNotificationService, $filter, $cookieStore, $rootScope, _notificationService_) {
        ...
        spyOn(notificationService, 'getNotificationMessage').and.returnValue(convertedNotificationText);
    ...
    describe('when the Notification web API object', function () {
        ...
        it('is not set in our browser', function () {
            ...
            expect(notificationService.getNotificationMessage).not.toHaveBeenCalled();
        });
    ...
    describe('check notification list behaviour', function () {
        ...
        it('when that list is set all notifications should be send', function () {
            ...
            expect(notificationService.getNotificationMessage.calls.count()).toEqual(2);
            expect(notificationService.getNotificationMessage).toHaveBeenCalledWith(newNotifications[0]);
            expect(notificationService.getNotificationMessage).toHaveBeenCalledWith(newNotifications[1]);
        });
    ...
    describe('check cookies that save already shown notifications', function () {
        ...
        it('pass 2 new notifications but one was shown before', function () {
            ...
            expect(notificationService.getNotificationMessage.calls.count()).toEqual(1);
        });
        ...
        it('pass 2 new notifications but both are marked as shown before', function () {
            ...
            expect(notificationService.getNotificationMessage.calls.count()).toEqual(0);
        });
